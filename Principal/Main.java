...
public class ClasePrincipal {public static void main (String [] args) {Scanner leer = new Scanner (System.in); int [] Arreglo1 = new int [5]; // Declaramos Arreglo int valor = 0; int cont = 0; // Declaramos contador
